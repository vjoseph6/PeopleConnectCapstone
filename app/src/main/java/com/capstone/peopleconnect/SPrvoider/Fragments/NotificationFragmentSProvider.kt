 ...
 * Use the [NotificationFragmentSProvider.newInstance] factory method to
...
class NotificationFragmentSProvider : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotificationFragmentSProvider.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                NotificationFragmentSProvider().apply {
