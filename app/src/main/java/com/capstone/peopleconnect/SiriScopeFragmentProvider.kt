...
class SiriScopeFragmentProvider : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_siri_scope_provider, container, false)
    ...
    companion object {
        ...
        fun newInstance(email: String?) =
            SiriScopeFragmentProvider().apply {
