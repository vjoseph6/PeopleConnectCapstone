 ...
 * Use the [SettingsSecurityFragmentClient.newInstance] factory method to
...
class SettingsSecurityFragmentClient : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SettingsSecurityFragmentClient.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SettingsSecurityFragmentClient().apply {
